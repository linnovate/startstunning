  ...
  if (window.getComputedStyle || (window.getComputedStyle = function(a) {
    ...
    C.startAutoplay = function() {
      if (C.support.transitions) {
        ...
        if (!b.autoplay) return;
        C.callPlugins("onAutoplayStart"), b.onAutoplayStart && C.fireCallback(b.onAutoplayStart, C), aa = setInterval(function() {
          b.loop ? (C.fixLoop(), C.swipeNext(!0)) : C.swipeNext(!0) || (b.autoplayStopOnLast ? (clearInterval(aa), aa = void 0) : C.swipeTo(0))
        }, b.autoplay)
      }
      ...
      } else aa && clearInterval(aa), aa = void 0, C.callPlugins("onAutoplayStop"), b.onAutoplayStop && C.fireCallback(b.onAutoplayStop, C)
