...
(function() {
  ...
  getItemsPromise = function(request) {
    return getPromise(request, function(res) {
      ...
      data = [];
      _.each(res != null ? res.items : void 0, function(itemData) {
...
(function() {
  ...
  if (/(MSIE|Trident)/i.test(window.navigator.userAgent || '')) {
    ...
    return _.each([collectionsRequests, authRequests, itemsRequests], function(requests) {
      return _.each(requests, function(request, name) {
...
authorizeOnFail = function(methods, methodsNames) {
  return _.each(methodsNames, function(methodName) {
    var method;
...
CollectionModel = (function() {
  ...
  CollectionModel.prototype._mergeProperties = function(serverData) {
    ...
    _.each(modelData, function(val, key) {
...
CollectionsListModel = (function(_super) {
  ...
  CollectionsListModel.prototype.getAll = function(type, withItems) {
    ...
    return collectionsRequests.getAll(type, withItems).then(function(allModelsData) {
      _.each(allModelsData, function(modelData) {
        return new Collection(toClientModel(modelData));
      });
      _.each(_this, function(savedCollection) {
        var obsolete;
...
(function() {
  ...
  ItemModel = (function() {
    ...
    ItemModel.prototype._mergeProperties = function(serverData) {
      ...
      return _.each(toClientModel(serverData), function(val, key) {
...
(function() {
  ...
  callWithOrWithoutIds = function() {
    ...
    itemsWithIds = _.select(serverItems, function(i) {
      return i.id != null;
    });
    itemsWithoutIds = _.select(serverItems, function(i) {
      return i.id == null;
    });
  ...
  sort = function(itemsList) {
    ...
    itemsList.length = 0;
    return _.each(sorted, function(i) {
  ...
  ItemsListModel = (function(_super) {
    ...
    function ItemsListModel(_collection, items) {
      ...
      ItemsList.on('delete', function(promise, event, items) {
        return promise.then(function() {
          return _.each(items || event.model, function(i) {
            return remove(i);
          });
        });
      });
    ...
    ItemsListModel.prototype._merge = function(serverItems) {
      var _this = this;
      return _.each(serverItems, function(itemData) {
        var foundItem;
...
Events = (function() {
  ...
  */
  ...
  function Events(methods, _eventsNames) {
    ...
    _.each(this._eventsNames, function(name) {
      var method;
      if (methods[name]) {
        method = methods[name];
  ...
  */
  ...
  Events.prototype.trigger = function() {
    ...
    return _.each(this.eventHandlers[eventName] || [], function(handlerData) {
      var _ref;
